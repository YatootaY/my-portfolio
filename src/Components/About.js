    ...
    return(
        <div className="About" id="about">
            <div className="aboutText">
                <p className="yellowText hidden">Still having confused feeling ❓</p>
                <h2 className="whiteTitle hidden">Let’s get to know better!</h2>
                <p className="aboutPara hidden">
