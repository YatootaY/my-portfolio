    ...
    return(
        <div className="Work">
            ...
            <div className="workDetails hidden">
                <h2>However 😎,</h2>
                <p>I have a strong understanding of programming languages and am also skilled at explaining complex concepts, which enabled me to work as <br/>a <span>Computer Science and Robotics Instructor</span> in the following organizations.</p>
            </div>
